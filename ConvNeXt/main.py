...
from datasets import build_dataset, build_kfold_dataset
...
#     dataset_train, args.nb_classes = build_dataset(is_train=True, args=args)
    dataset_train, dataset_val = build_kfold_dataset(args)
...
#         dataset_val, _ = build_dataset(is_train=False, args=args)
    ...
    print('AAAAAAAAAAAAAAAAAAAAAA>', args.model)
    model = create_model(
        args.model, 
        pretrained=False, 
        ...
        if data_loader_val is not None:
            ...
            if max_accuracy < test_stats["acc1"]:
                ...
                if args.output_dir and args.save_ckpt:
                    utils.save_model(
                        args=args, model=model, model_without_ddp=model_without_ddp, optimizer=optimizer,
                        loss_scaler=loss_scaler, epoch="best_" + str(args.n_fold), model_ema=model_ema)
